...
<?php
	...
	elseif($leave_days <= 0)
	{
	    echo "<script>alert('ANDA MELEBIHI BATAS CUTI ANDA.  PENGAJUAN CUTI GAGAL');</script>";
	  }
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Apply for Cuti</li>
								</ol>
							</nav>
						</div>
					</div>
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<div class="modal-footer justify-content-center">
												<button class="btn btn-primary" name="apply" id="apply" data-toggle="modal">Apply&nbsp;Cuti</button>
											</div>
										</div>
									</div>
								</div>
