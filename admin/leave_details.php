		...
		<div class="pd-ltr-20">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Detail Cuti</h4>
							<p class="mb-20"></p>
						</div>
					</div>
					<form method="post" action="">
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b> Tanggal Apply</b></label>
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>Sisa Cuti</b></label>
							...
							<div class="col-md-4">
								<div class="form-group">
									<label style="font-size:16px;"><b>Periode Cuti</b></label>
						...
						<div class="form-group row">
								<label style="font-size:16px;" class="col-sm-12 col-md-2 col-form-label"><b>Alasan Cuti</b></label>
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group">
									<label style="font-size:16px;"><b> Status Cuti HOD</b></label>
							...
							<div class="col-md-3">
								<div class="form-group">
									<label style="font-size:16px;"><b>Registry Status</b></label>
